...
if(isset($_POST["submit"])){
   ...
   // if(in_array($fileType, $allowTypes)|| in_array($fileType2, $allowTypes)|| in_array($fileType3, $allowTypes)|| in_array($fileType4, $allowTypes)|| in_array($fileType5, $allowTypes)){
...
<div class="card mb-4">
  <br><h3 class="m-0 font-weight-bold text-primary">අවසර පත්‍ර තොරතුරු</h3><br>
  </div>
<!--<div class="card mb-4">
...
$queryr = $conn->query("SELECT * from applicant WHERE nic = '$apid'");
  ...
  <label for="inputEmail3" class="col-sm-2 col-form-label">පොලිස් ස්ථානය</label>
      ...
      <h5 class="m-0 font-weight-bold text-primary">භූ විද්‍යා සමීක්ෂණ හා පතල් කාර්‍යාංශ බලපත්‍රය</h5>
          ...
          <label for="inputPassword3" class="col-sm-2 col-form-label">මාසික නිෂ්පාදන පරිමාව <span style="color:red">*</span></label>
            ...
            <label for="inputEmail3" class="col-sm-2 col-form-label">වලේ ගැඹුර(අඩි) <span style="color:red">*</span></label>
            <div class="col-sm-4">
...
<br><br><input type="hidden" name="permid" value="<?php echo $permitid; ?>">
          <div class="form-group row">
