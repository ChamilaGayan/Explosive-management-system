...
$q6 = $conn->query("SELECT * from ins_report WHERE aplicant_id = $id");
  ...
  <div id="wrapper">
   ...
   ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     <div class="my-2"></div>
      <?php echo "<a href='permit_view.php?id=$id' class='btn btn-success btn-icon-split'>"; ?> 
      ...
      <center><?php 
          ...
          //echo "<img id='scream'  class='img-fluid' width='800' height='800'src='$img1' alt='.'>"; 
           ...
           echo "<embed src='$img1' class='img-fluid' width='800' height='800' />";
           }
           else if($type == '2') 
           {
           ...
           {
            echo "<embed src='$img6' class='img-fluid' width='800' height='800' />";
           }
