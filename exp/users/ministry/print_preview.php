  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
     ...
     ?>
                    ...
                    <div class="form-group row py-sm-1 mb-0">
                    <label for="inputPassword3" class="col-sm-6 ">(III)(අ): මීට කලින් අයදුම්කරු විසින් අයදුම්පත් ඉදිරිපත් කරනු ලැබ තිබේද?</label>
                    ...
                    <div class="form-group row py-sm-1 mb-0">
                      <label for="inputEmail3" class="col-sm-4 col-form-label">ඉදිරිපත් කර ඇතිනම් ලිපිගොනුවේ යොමු අංකය:</label>
                      <div class="col-sm-6">
...
<br>
                    <div class="form-group row py-sm-1 mb-0">
                      <label for="inputEmail3" class="col-sm-3 ">(ඇ): වර්තමාන අයදුම්පත් කාර්යය:</label>
                      <div class="col-sm-7">
...
?>
                    ...
                    <br>
                    <div class="form-group row py-sm-1 mb-0">
                      <label for="inputPassword3" class="col-sm-4">02: පොලිසිය විසින් නිර්දේශ කරනු ලැබ තිබේද?:</label>
                      <?php echo "<label for='inputEmail3' >$pls </label>"; ?> 
					</div>
                 
                    <div class="form-group row py-sm-1 mb-0">
                      <label for="inputEmail3" class="col-sm-6 col-form-label">03: පුපුරන ද්‍රව්‍ය ගබඩා කරන ආකාරය සහ ඒවා ගබඩා කරන ස්ථානය:</label>
                      <div class="col-sm-6">
                    ...
                    <div class="form-group row py-sm-1 mb-0">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">06: අවසරපත්‍රය වලංගු වන කාලය (මාස): </label>
                      <div class="col-sm-7">
                      <?php echo "<label for='inputEmail3' class='col-sm-7 col-form-label'>$ntime </label>"; ?>
                      </div>
                    </div>
                    ...
                    <div class="form-group row py-sm-1 mb-0">
                      <label for="inputEmail3" class="col-sm-9 col-form-label"></label>
                      <div class="col-sm-3">
                      <label for="inputEmail3" >දිස්ත්‍රික් ලේකම්/දිසාපති</label>
                      </div>
