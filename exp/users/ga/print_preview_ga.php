...
?>
		...
		<div class="form-row">
        <div class="col-md-12">(අ). අමාත්‍යංශ ලිපිගොනුවේ යොමු අංකය:<?php echo $oldreq_no; ?></div>
        </div>
		<div class="form-row">
        <div class="col-md-12">(ආ).  දැනට ඔහු ලඟ ඉතිරි වී ඇති පුපුරන දව්‍ය වර්ග හා ප්‍රමාණය :<?php echo $oldreq_no; ?></div>
        </div>
		<div class="form-row">
        <div class="col-md-12">
		<!------------------------------------->
...
<?php 
    ...
    ?>
		...
		<div class="form-row">
        <div class="col-md-12"><p>12:ඉහත අනුමැතියට යටත්ව නිකුත් කල අවසරපත්‍රයේ අංකය හා දිනය: <?php echo $c_approval_no ;?></p></div>
        </div>
		<div class="form-row">
